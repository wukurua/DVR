...
#include <memory>
#include "../view/control/verificationcodelabel.h"
...
void VerificationCodeLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VerificationCodeLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject VerificationCodeLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_VerificationCodeLabel.data,
    qt_meta_data_VerificationCodeLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
